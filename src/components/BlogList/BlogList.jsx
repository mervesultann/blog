...
const BlogList = () => {
  ...
  // Arama kriterine göre blogları filtrele
      ...
      <div style={{ flex: 3 }}>
        <div>
          ...
          <div className="filter">
            <button onClick={filteredAuthor}>Yazara Göre Filtrele</button>
            <button onClick={filteredDate}>Tarihe Göre Filtrele</button>
          </div>
